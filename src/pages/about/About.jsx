...
const About = () => {
  return (
    ...
    <section classNameName="page-content">

        <div classNameName="row">
            <div classNameName="column">

                <p classNameName="lead drop-cap">
                ...
                <div classNameName="row">
                    <div classNameName="column large-half medium-full">
                        <h2>Our Purpose.</h2>
                        <p>
                ...
                <h2>Our Values.</h2>
                <div classNameName="row block-large-1-2 block-1000-full block-list">
                    <div classNameName="column block-list__item">
                ...
                <div classNameName="row block-large-1-2 block-tab-full church-staff">
                    <div classNameName="column church-staff__item">
                        <div classNameName="church-staff__header">
                            <div classNameName="church-staff__picture">
                                <img src="images/avatars/user-01.jpg" alt="" />
                            </div>
                            <h4 classNameName="church-staff__name">
                                Jonathan Doe
                                <span classNameName="church-staff__position">
                                    Lead Pastor
                                </span>
                            </h4>
                        </div>
